namespace JackTheVideoRipper
{
   partial class FrameMainNew
   {
      ...
      private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrameMainNew));
         ...
         toolBar.Location = new Point(0, 29);
         toolBar.Name = "toolBar";
         toolBar.Padding = new Padding(2, 0, 1, 0);
         toolBar.Size = new Size(1213, 46);
         toolBar.TabIndex = 2;
         ...
         toolStripButtonDownloadVideo.Size = new Size(40, 43);
         toolStripButtonDownloadVideo.ToolTipText = "Download Media as Video";
         // 
         // toolStripSeparator13
         // 
         toolStripSeparator13.Name = "toolStripSeparator13";
         toolStripSeparator13.Size = new Size(6, 46);
         // 
         ...
         toolStripButtonDownloadAudio.Size = new Size(40, 43);
         ...
         toolbarLabelProcessCounts.Size = new Size(383, 43);
         toolbarLabelProcessCounts.Text = "Active (0) // Running (0) // Paused (0) // Total (0)";
         // 
         // statusBar
         // 
         statusBar.Anchor = AnchorStyles.None;
         ...
         toolbarLabelStatus.Padding = new Padding(5, 0, 0, 0);
         toolbarLabelStatus.Size = new Size(112, 23);
         ...
         toolbarSeparator1.Size = new Size(13, 23);
         ...
         toolBarLabelCpu.Size = new Size(86, 23);
         ...
         toolbarSeparator2.Size = new Size(13, 23);
         ...
         toolBarLabelMemory.Size = new Size(188, 23);
         ...
         toolbarSeparator3.Size = new Size(13, 23);
         ...
         toolBarLabelNetwork.Size = new Size(172, 23);
         ...
         toolbarSeparator4.Size = new Size(13, 23);
         ...
         notificationStatusLabel.Size = new Size(576, 23);
         ...
         toolStripStatusLabel4.Size = new Size(13, 23);
         ...
         tableLayoutPanel.Controls.Add(toolBar, 0, 1);
         tableLayoutPanel.Controls.Add(listItems, 0, 2);
         tableLayoutPanel.Controls.Add(statusBar, 0, 3);
         ...
         tableLayoutPanel.Size = new Size(1213, 705);
         ...
         listItems.Location = new Point(0, 75);
         listItems.Margin = new Padding(0);
         listItems.MultiSelect = false;
         listItems.Name = "listItems";
         listItems.Size = new Size(1213, 601);
